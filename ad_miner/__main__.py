...
from ad_miner.sources.modules.common_analysis import rating_color
...
def main() -> None:
    ...
    extract_date, total_objects, number_relations, boolean_azure = pre_request(
        arguments
    )
