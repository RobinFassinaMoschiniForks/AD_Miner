...
@register_control
class users_admin_of_computers(Control):  # TODO change the class name
    ...
    def __init__(self, arguments, requests_results) -> None:
        ...
        self.title = "Users admin of machines"
    ...
    def run(self):
        ...
        def generateGraphPathToAdmin(self):
            ...
            subpage_dico_description: dict[str, str] = {
        ...
        self.name_description = f"{self.data} users with admin privs."
